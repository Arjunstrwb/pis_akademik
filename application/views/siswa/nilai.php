        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header  with-border">
                ...
                ?>
              <h3 class="box-title">Data Nilai Siswa <?php echo $namanya = $nama['nama']." / ".$nisnnya = $nama['nisn']; ?></h3>
            ...
            <?php
                ...
                echo anchor('nilai/add_nilai/'.$nisnnya = $nama['nisn'], '<button class="btn bg-navy btn-flat margin">Tambah Data</button>');
                
            ?>

            <a target="_blank" class="btn bg-blue btn-flat margin" href="<?= base_url('siswa/report_nilai').'?nama='.$namanya = $nama['nama'].'&nisn='.$nisnnya = $nama['nisn']; ?>">CETAK</a>
